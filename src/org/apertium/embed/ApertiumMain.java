...
//    public static final String DATA_DIRECTORY = "/home/dx/gsoc2012/_apertium/eo-en-only-need/";
...
//    }
    ...
    private static Reader _getFileReader(String input, String encoding) throws UnsupportedEncodingException, FileNotFoundException {
//        return new InputStreamReader(ApertiumMain.class.getResourceAsStream("eotest.input"), encoding);
    ...
    private static boolean _parseCommandLine(ApertiumMain.CommandLineParams clp, String input, String modes) throws Exception {
        ...
        if (clp.extInput == null) {
            clp.extInput = _getFileReader(input, "UTF-8");
        }
...
//        input = new StringReader("Saluton, mi estas Jacob");
     ...
     * @throws Exception
     */
    public static String run(String input, String modes)
            throws Exception {
